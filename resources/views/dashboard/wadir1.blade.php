...
@section('content')
    ...
    <div class="dashboard-container">
        <h2 class="title">Dashboard Wadir I</h2>
        ...
        <div class="stats">
            ...
            <div class="card-stat">
                ...
                <div class="number">{{ number_format($rataCapaian, 2) }}%</div>
                <div class="label">Rata-rata Capaian OBE</div>
            </div>
        </div>

        <div class="chart-container mt-5">
            <h5 class="fw-semibold mb-3">Rata-rata Capaian OBE per Program Studi</h5>
    ...
    <script>
        ...
        new Chart(ctx, {
            type: 'bar',
            data: {
                labels: {!! json_encode($capaianPerProdi->pluck('nama_prodi')) !!},
                datasets: [{
                    label: 'Rata-rata Capaian (%)',
                    data: {!! json_encode($capaianPerProdi->pluck('rata')) !!},
